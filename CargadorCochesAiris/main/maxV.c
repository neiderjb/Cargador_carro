...
/*Control on IGBT 1*/
void igbt1_write_maxV(int state_igbt1)
{
    gpio_write(ALE, 1);
    gpio_write(AD0, 0);
    gpio_write(AD1, 0);
...
/*Control on IGBT 2*/
void igbt2_write_maxV(int state_igbt2)
{
    gpio_write(ALE, 1);
    gpio_write(AD0, 0);
    gpio_write(AD1, 0);
...
/*Control on IGBT 3*/
void igbt3_write_maxV(int state_igbt3)
{
    gpio_write(ALE, 1);
    gpio_write(AD0, 0);
    gpio_write(AD1, 0);
